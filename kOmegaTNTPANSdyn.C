...
void kOmegaTNTPANSdyn<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
kOmegaTNTPANSdyn<BasicTurbulenceModel>::kOmegaTNTPANSdyn
(
...
template<class BasicTurbulenceModel>
bool kOmegaTNTPANSdyn<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaTNTPANSdyn<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
